...
let SALARY = [
  {
    name: "1st co-op",
    value: [
      5, 14, 15, 15, 17, 17.31, 17.5, 17.5, 18, 18, 18, 18, 18, 18, 18, 18, 18,
      18, 18, 18.5, 18.75, 19, 19, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 21,
      21, 21, 21.5, 22, 22, 22.08, 23, 24, 24, 24, 25, 25, 25, 25, 25, 32, 42.9,
      45.5, 55.9,
    ],
  },
  {
    name: "2nd",
    value: [
      17, 17, 17.5, 18, 18, 18, 20, 20, 20, 20, 20, 20, 21, 21, 21, 21, 22, 22,
      22, 22, 22, 23, 23, 25, 25, 25.14, 26, 26, 28, 28, 30, 33, 35, 35, 38, 39,
      40, 42, 43.875, 45.5, 46.8, 46.8, 46.8, 46.8, 48.75, 54.6, 58.5, 60, 63.7,
      65, 67.6,
    ],
  },
  {
    name: "3rd",
    value: [
      20, 21.33, 22, 22, 22.5, 23, 23, 23.75, 24, 24, 24, 24, 24, 24, 24, 24.68,
      25, 25, 25, 28, 30, 30, 30, 32, 33, 35, 35, 36, 38, 40, 43, 45, 45, 45.5,
      46, 47.3, 52, 54.6, 55, 55.9, 55.9, 57.2, 58.5, 58.5, 62.4, 65, 65, 68.9,
      78,
    ],
  },
  {
    name: "4th",
    value: [
      21.5, 22, 23, 25, 25, 26, 26, 30, 30, 31, 32, 33, 35, 39, 52, 52, 52.494,
      54.6, 55.9, 56.251, 58.5, 58.5, 58.5, 58.5, 58.5, 58.5, 59.995, 61.1,
      62.4, 62.4, 62.4, 62.4, 62.4, 62.4, 63.7, 65, 65, 65, 65, 70, 71.5, 71.5,
      71.5, 71.5, 75.4, 78, 78, 84.006, 89.375, 115,
    ],
  },
  {
    name: "5th",
    value: [
      0, 24, 26.05, 28, 29, 29, 30, 31, 32.5, 35, 35, 36, 37, 38, 39, 53.3,
      53.3, 54.795, 55, 55.9, 58, 58.5, 58.5, 59.8, 59.8, 61.1, 61.1, 62.4,
      62.4, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 65, 67.47, 71.5, 81.9, 83.2,
      87.75, 100, 105.13, 110.5, 130,
    ],
  },
  {
    name: "6th co-op",
    value: [
      25, 29, 31, 33, 34, 35, 35, 35.1, 36, 36, 39, 40, 40, 40, 40, 40, 40, 40,
      40.38, 41, 41, 41, 42, 44, 44, 45, 47, 48, 65, 70, 70.71, 92.5, 93.756,
      100, 107.9, 111.8, 127, 130, 130, 136.5, 158,
    ],
  },
];
...
let HACKATHON_SALARY = [
  {
    name: "0",
    value: [
      16.0, 22.0, 24.75, 25.0, 25.0, 25.0, 26.8, 28.5, 30.0, 32.83, 33.3, 33.95,
      35.67, 38.0, 43.88, 47.7, 52.12, 54.28,
    ],
  },
  {
    name: "1-5",
    value: [
      24.16666667, 24.41, 24.7, 27.85, 30.16666667, 36.65, 37.71666667, 38.15,
      38.66666667, 42.2, 44.06666667, 44.46, 47.85016667, 48.41666667, 49,
      49.13333333, 61, 65.65933333, 68.8, 80,
    ],
  },
  {
    name: ">5",
...
let SIDE_SALARY = [
  {
    name: "0h / term",
    value: [
      16, 22, 24.16666667, 25, 25, 25, 26.66666667, 26.8, 28.5, 29.66666667, 30,
      30.16666667, 31.83333333, 33.3, 33.83333333, 33.953, 35.66666667, 36.65,
      37.71666667, 38.15, 42.2, 43.425, 44.06666667, 44.46, 47.85016667,
      48.41666667, 49.13333333, 50.4, 52.11666667, 61, 66.6, 78.67916667, 80,
    ],
  },
  {
    name: "1-50h / term",
    value: [
      24.41, 24.7, 24.75, 28.33333333, 32.83333333, 37.78333333, 38,
      38.16666667, 38.66666667, 39.83333333, 41.35, 42.4248, 43.88333333,
      44.36833333, 49, 52.35016667, 54.275, 65.65933333, 68.8,
    ],
  },
  {
    name: ">50h / term",
...
let ADMISSION_SALARY = [
  {
    name: "<=95",
    value: [
      16, 22, 24.41, 26.66666667, 26.8, 28.33333333, 28.5, 29.66666667,
      31.83333333, 33.3, 33.83333333, 34.72, 36.65, 38.16666667, 38.66666667,
      42.2, 43.425, 44.46, 46.3, 50.4, 68.8,
    ],
  ...
  },
  {
    name: ">95",
    value: [
      24.16666667, 24.7, 24.75, 25, 25, 25, 27.85, 30, 30.16666667, 32.83333333,
      33.953, 35.66666667, 37.71666667, 37.78333333, 38, 38.15, 39.83333333,
      41.35, 42.4248, 43.88333333, 44.06666667, 44.36833333, 47.7, 47.85016667,
      48.41666667, 49, 49.13333333, 51, 52.11666667, 52.35016667, 54.275, 56.65,
      60.226, 61, 65.65933333, 66.6, 78.67916667, 80,
    ],
    toggle: "admission-salary-overall",
  },
  {
    name: "<=95",
    value: [
      15, 15, 18, 18, 18, 18, 18.75, 19, 20, 20, 20, 21, 21, 22, 22, 22.08, 23,
      25, 42.9,
    ],
  ...
  },
  {
    name: ">95",
    value: [
      5, 14, 17, 17.31, 17.5, 17.5, 18, 18, 18, 18, 18, 18, 18, 18.5, 19, 20,
      20, 20, 20, 20, 20, 20, 21, 21.5, 24, 24, 24, 25, 25, 25, 25, 32, 45.5,
      55.9,
    ],
    toggle: "admission-salary-first-year",
  },
...
let FAVOURITE_COOP_REASON = [
  ...
  { name: "Pay", value: 7 },
  { name: "Perks", value: 6 },
  { name: "Work & Projects", value: 13 },
  { name: "Location", value: 2 },
  { name: "Team & Co-workers", value: 6 },
  { name: "Friendships", value: 7 },
  { name: "Intern Experience", value: 6 },
];

const COOP_RATINGS = [
  {
    group: "Coop 1",
    "rating-outstanding": 23,
    "rating-excellent": 29,
    "rating-very-good": 2,
...
const COOP_BREAKDOWN = [
  {
    group: "Coop 1",
    "coop-app-num": 82.46,
    "coop-app-num-ext": 93.6,
    "coop-interviews": 6.53,
    "coop-offers": 1.6,
  },
  {
    group: "Coop 2",
    "coop-app-num": 62.7,
    "coop-app-num-ext": 56.6,
    "coop-interviews": 8.18,
    "coop-offers": 2.15,
  },
  {
    group: "Coop 3",
    "coop-app-num": 53.18,
    "coop-app-num-ext": 49.82,
    "coop-interviews": 6.56,
    "coop-offers": 2.16,
  },
  {
    group: "Coop 4",
    "coop-app-num": 41.51,
    "coop-app-num-ext": 50.82,
    "coop-interviews": 8.2,
    "coop-offers": 2.84,
  },
  {
    group: "Coop 5",
    "coop-app-num": 36.11,
    "coop-app-num-ext": 27.92,
    "coop-interviews": 8.12,
    "coop-offers": 2.76,
  },
  {
    group: "Coop 6",
    "coop-app-num": 26.14,
    "coop-app-num-ext": 30.5,
    "coop-interviews": 3.62,
    "coop-offers": 1.82,
  },
];
...
const COOP_JOBS = [
  {
    group: "Coop 1",
    "coop-first-round": 47.17,
    "coop-continuous": 32.08,
    "coop-external": 20.75,
  },
  {
    group: "Coop 2",
  ...
  {
    group: "Coop 3",
    "coop-first-round": 59.18,
    "coop-continuous": 20.41,
    "coop-external": 20.41,
  },
  {
    group: "Coop 4",
  ...
  {
    group: "Coop 5",
    "coop-first-round": 65.31,
    "coop-continuous": 6.12,
    "coop-external": 28.57,
  },
  {
    group: "Coop 6",
    "coop-first-round": 36.59,
    "coop-continuous": 2.44,
    "coop-external": 60.98,
  },
];
