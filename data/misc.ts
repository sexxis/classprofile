...
let SE_STORYTIME = ["My best friend was the person I first met at Waterloo!", "I will always remember the time that a former SE Director gave my friend and I a ride across South Island, New Zealand in the middle of the night because neither of could drive. SE community really coming in clutch!", "Studying in the SE lab at 1am, had a final the next day, stressed out. Friend walked in with a bottle of alcohol and we got drunk. We both passed the final LOL", "I was living with 4 friends once and since we're all lazy and cheap, we calculated that coupon discounted XL Dominos pizzas split up over multiple meals was the most cost efficient way to make meals without cooking. By the end of the term we had absolutely stuffed an entire closet with boxes. So we brought them all to the fire pit close to Laurel Creek and had a big glorious bonfire."];

// Can you share your favourite moment from 2021 or 2022?
let FAVOURITE_2021_2022_MOMENT = [, "Falling in (real!) love for the first time :)", "When I realized I didn't have to go back to Waterloo."
];

// Can you share your favourite moment from first year?
let FAVOURITE_FIRST_YEAR_MOMENT = ["Saturday night EngPlay show, just jamming to the music off-stage.", "Got drunk, slept for 3 hours, woke up and aced quiz", ,];

// Any other fun first year stories?
let OTHER_FIRST_YEAR_STORIES = ["In CS 137 someone told us iClickers were not required for that specific day, turns out it was.", "Slept in and missed half of the combinatorics exam :') still passed thankfully", "A friend of mine thought it would be fun to try and pat a goose during mating season but instead he got one of his fingers bitten, ******* idiot lol", "V1 Great Hall 24-hour grind"];

// Can you share a funny story about interviewing or co-op?
let INTERVIEW_COOP_STORY = ["first interview ever I had with a FAANG company, when the interviewer asked \"how did i do X\" from my resume, I told them \"I kind of just got lucky i guess\"", "Happened during first year, this interviewer tried to recruit me as a technical co-founder for his startup. I barely knew how to code, and had the toughest time getting myself out of that interview!"];

// What was your favourite co-op experience?
let COOP_STORY = ["I changed the preferred yogurt brand of my company by re-arranging the office fridge.", "Company-wide offsite and bonfire", "Working at a company of 10 people as one of three developers", "One time a coworker described the placenta as the Decorator Pattern and it stuck with me ever since", "Getting flown to SF for a company Christmas party", "PM at Apple", , "Very first coop, met some great friends and had a blast!", "Going to California for the first time, and living with friends.", "Playing foosball with the other co-ops.", "Going to NYC on a business trip with the rest of my company!", "Sitting around the table eating with the other interns at Wish summer camp (Winter 2019)."];
...
let CRYING = [2, 0, 1, 4, 1, 0.5, 0, 2, 2, 0, 3, 0, 0, 3, 4, 5, 2, 0.375, 0, 0, 3, 5, 0, 4, 0, 3, 3, 2, 2, 1, 2, 1, 0, 0, 0.5, 2, 0, 0, 1, 7, 1, 1, 0, 3];
...
let SOCIAL_MEDIA = [2, 10, 6, 7, 15, 4, 3, 15, 8, 0.5, 10, 7, 7, 7, 2, 10, 7, 10, 2, 20, 3, 10, 7, 7, 10, 7, 4, 8, 5, 10, 21, 2, 20, 10, 0.5, 2, 6, 15, 10, 0, 2, 23, 1, 20, 6, 11, 5];

// On average, How many hours did you play video games per week during your undergrad? (put 0 if never on it)
let VIDEO_GAMES = [3, 6, 0, 4, 0, 0, 12, 12, 8, 7, 1, 0.5, 4, 5, 0, 6, 2, 0, 1, 10, 3, 20, 0.25, 0, 1, 0, 0, 0.5, 15, 2, 1, 5, 1, 5, 0, 12, 1, 0, 10, 2, 1, 0, 0, 2, 2, 0];
...
let POST_COVID_TRAVEL = {
  "Singapore": 2, "Taiwan": 1, "Canada": 1, "Russia: culture and the wilderness": 1, "Japan": 8, "Italy": 1, "Asia": 1, "Germany: soccer games": 1, "South Korea: fried chicken, soju": 4, "Tuscaloosa, Alabama: Crimson Tide home football game": 1, "Europe": 2, "Paris, France": 1, "Italy: PIZZA": 1, "Amsterdam, Netherlands, since I had planned to travel there but cancelled due to Omicron": 1, "China: visit family, culture": 2, "San Francisco": 1, "Germany: drive around": 1, "United Kingdom, Would love to watch a cricket game :D": 1, " Tanzania: the Serengeti": 1, "South America: ancient ruins": 1, "India": 1
};
